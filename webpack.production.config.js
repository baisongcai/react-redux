...
module.exports = {
    ...
    module: {
        loaders: [{ test: /\.(js|jsx)$/, exclude: /node_modules/, loader: 'babel-loader',query: {presets: ['react', 'es2015']}},
    ...
    plugins: [ // webpack 内置的 banner-plugin
        new webpack.BannerPlugin("Copyright by bsc"),
        // html 模板插件
